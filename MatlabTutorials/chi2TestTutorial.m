...
%
% Note that if you will look closely, you'll see that the theory and draws diverge
% a little at low values on the histogram.  Can you understand why?  Is there a better
% way to compute the theoretical values that avoids this problem.  (Hint: think about
% the difference between the PDF and the CDF.)
nSamples = 5000;
r1 = randn(nSamples,1);
chisquare1 = r1.^2;
